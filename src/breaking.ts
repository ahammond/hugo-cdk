...
export interface BreakingProps extends StackProps {
  /**
...
export class Breaking extends Construct {
  public readonly project: aws_codebuild.Project;

  constructor(scope: Construct, id: string, props: BreakingProps) {
    super(scope, id);
...
export class BreakingStack extends Stack {
  public readonly project: aws_codebuild.Project;

  constructor(scope: Construct, id: string, props: BreakingProps) {
    super(scope, id, props);
    const p = new Breaking(this, id, props);
